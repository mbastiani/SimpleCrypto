...
namespace Mbs.SimpleCrypto.Services
{
    public class SimpleAesCryptoService : ISimpleAesCryptoService
    {
        private const int IV_LENGTH = 16;
        private const int KEY_SIZE = 256;

        public string AesEncrypt(string contentToBeEncrypted, string privateEncryptionKey)
        {
        ...
        public string AesDecrypt(string contentToBeDecrypted, string privateEncryptionKey)
        {
